...
public class BKPBanco {
    public boolean bkpBanco() throws ClassNotFoundException, SQLException{
        ConBD cbd = new ConBD();
        Connection con = cbd.abrirConexao();
        PreparedStatement ps = con.prepareStatement("create table onibus(cod serial primary key,modelo varchar (30),gasto real);"
                + "--============================================================================================================="
                + "create table gasto("
