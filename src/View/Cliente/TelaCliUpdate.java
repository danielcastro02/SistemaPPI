...
public class TelaCliUpdate extends Window {
    ...
    public TelaCliUpdate(GUIScreen gui, int aux) throws ClassNotFoundException, SQLException {
        super("Lista de Clientes");
        this.gui = gui;
        init(aux);
    }
    public TelaCliUpdate(GUIScreen gui, int aux, String a) throws ClassNotFoundException, SQLException {
        super("Lista de Clientes");
        this.gui = gui;
        init(aux, a);
    }
    ...
    public void init(int PrimReg) throws ClassNotFoundException, SQLException {
     ...
     public void init(int PrimReg, String a) throws ClassNotFoundException, SQLException {
        ContCli cocli = new ContCli();
        setBorder(new Border.Standard());
        Panel painel01 = new Panel(Panel.Orientation.VERTICAL);
        painel01.setBetweenComponentsPadding(1);
